...
Version  : 2024.2.1
Release  : 53
URL      : https://cran.r-project.org/src/contrib/GPArotation_2024.2-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/GPArotation_2024.2-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707151685
