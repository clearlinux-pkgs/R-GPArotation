...
Version  : 2025.3.1
Release  : 58
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/GPArotation_2025.3-1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/GPArotation_2025.3-1.tar.gz
...
popd
pushd ..
cp -a GPArotation buildavx512
popd
pushd ..
cp -a GPArotation buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744638968
...
/usr/lib64/R/library/GPArotation/tests/errormessages.R
/usr/lib64/R/library/GPArotation/tests/lp.R
/usr/lib64/R/library/GPArotation/tests/print-GPArotation.R
/usr/lib64/R/library/GPArotation/tests/rotations.R
/usr/lib64/R/library/GPArotation/tests/rotationsRS.R
